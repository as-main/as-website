...
// Remove the "edit" link from the content when logged in
...
function be_logo_url( $title, $inside, $wrap ) {
	$inside = sprintf( '<a class="logo-link" href="%s" title="%s">%s</a><span class="logo-small-text"><span>S</span><span>t</span><span>u</span><span>d</span><span>i</span><span>o</span><span>s</span></span>', esc_url( 'http://www.activatorstudios.com' ), esc_attr( get_bloginfo( 'name' ) ), get_bloginfo( 'name' ) );
